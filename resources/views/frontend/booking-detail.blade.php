    ...
    <div class="min-h-screen py-15 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid grid-cols-4 sm:grid-cols-6 gap-2">
                        @foreach ($kamar->galeri as $index => $gambar)
                            <button @click="activeTab = {{ $index }}" class="relative rounded-lg overflow-hidden border-2 transition-smooth group"
                                :class="activeTab === {{ $index }} ? 'border-primary' : 'border-neutral-200 hover:border-primary'">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-neutral-600">Dilengkapi dengan interior terkini dan aesthetic yang menawan</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-primary flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-neutral-600">Lokasi strategis dengan akses mudah ke berbagai fasilitas utama</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-primary flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-neutral-600">Semua kebutuhan Anda tersedia dengan standar premium</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
                                <svg class="w-6 h-6 text-primary flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-neutral-600">Kualitas terbaik dengan harga yang terjangkau dan fleksibel</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="mb-12">
                        ...
                        <div class="space-y-4">
                            <div class="glass-card rounded-lg p-4 border-l-4 border-primary">
                                ...
                                <p class="text-sm text-neutral-600">Check-in mulai pukul 14:00 dan check-out maksimal pukul 12:00. Early check-in atau late check-out dapat diatur sesuai ketersediaan.</p>
                            </div>
                            <div class="glass-card rounded-lg p-4 border-l-4 border-accent">
                                ...
                                <p class="text-sm text-neutral-600">Hewan peliharaan tidak diperbolehkan di kamar ini untuk menjaga kebersihan dan kenyamanan tamu lainnya.</p>
                            </div>
                            <div class="glass-card rounded-lg p-4 border-l-4 border-primary">
                                <h3 class="font-semibold text-neutral-900 mb-2">Penggunaan Fasilitas</h3>
                                <p class="text-sm text-neutral-600">Semua tamu wajib menjaga kebersihan dan kelestarian fasilitas kamar. Kerusakan yang disengaja akan dikenakan biaya tambahan.</p>
                            </div>
                            <div class="glass-card rounded-lg p-4 border-l-4 border-accent">
                                <h3 class="font-semibold text-neutral-900 mb-2">Kebijakan Pembatalan</h3>
                                <p class="text-sm text-neutral-600">Pembatalan gratis hingga 48 jam sebelum check-in. Pembatalan di bawah 48 jam akan dikenakan biaya 50% dari total pemesanan.</p>
                            </div>
                            <div class="glass-card rounded-lg p-4 border-l-4 border-primary">
                                <h3 class="font-semibold text-neutral-900 mb-2">Kesunyian</h3>
                                <p class="text-sm text-neutral-600">Harap menjaga kesunyian kamar terutama setelah pukul 22:00 untuk menghormati tamu lain. Suara yang mengganggu akan ditegur.</p>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="lg:col-span-1 sticky top-6 h-max">
                    <div class="glass-card rounded-2xl p-8 sticky top-8">
                        ...
                        <div class="mb-8 pb-8 border-b border-neutral-200">
                            <button
                                class="w-full flex items-center justify-center gap-2 bg-[#2563eb] hover:bg-[#1e40af] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg">
                                <!-- Icon Key - simbol akses kamar -->
                        ...
                        <div class="mt-8 pt-8 border-t border-neutral-200">
                            <div class="bg-primary/5 rounded-lg p-4">
                                <p class="text-xs text-neutral-600 leading-relaxed">
                                    <span class="font-semibold text-primary">Informasi Penting:</span> Untuk pertanyaan lebih lanjut atau kebutuhan khusus, silakan hubungi tim customer service kami yang
                                    siap membantu 24/7.
                                </p>
                            </div>
                        </div>
