...
@section('frontend-main')
    <div class="min-h-screen pt-28 pb-20 relative bg-[#fffffe]" x-data="{
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-3 space-y-6">
                    <div class="bg-[#fffffe] rounded-2xl border border-[#90b4ce]/30 p-6 sticky top-24 shadow-sm">
                        ...
                        <nav class="space-y-2">
                            <button @click="category = 'semua'; submitForm()"
                            ...
                            <button @click="category = 'Penting'; submitForm()"
                            ...
                            <button @click="category = 'Kegiatan'; submitForm()"
                            ...
                            <button @click="category = 'Perbaikan'; submitForm()"
                        ...
                        <select class="w-full bg-[#90b4ce]/5 border border-[#90b4ce]/30 rounded-xl px-4 py-2.5 text-sm text-[#5f6c7b] outline-none focus:ring-2 focus:ring-[#3da9fc]"
                            onchange="this.form.submit()" form="filter-form" name="sort">
                ...
                <div class="lg:col-span-9 space-y-8">
                        @if ($is_highlight)
                            <div class="relative overflow-hidden bg-[#094067] rounded-3xl p-8 md:p-12 text-white group cursor-pointer shadow-xl"
                                @click="showModal = true; selectedAnnouncement = {
                                title: '{{ addslashes($is_highlight->judul) }}',
                                date: '{{ \Carbon\Carbon::parse($is_highlight->created_at)->format('d M Y') }}',
                                category: '{{ ucfirst($is_highlight->kategori) }}',
                                content: '{{ addslashes(strip_tags($is_highlight->isi)) }}'
                            }">
        ...
        <template x-if="showModal">
            <div class="fixed inset-0 z-[999] overflow-y-auto flex items-center justify-center p-4 sm:p-6" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                <!-- Overlay -->
