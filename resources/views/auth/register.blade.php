        ...
        <div class="layered-surface rounded-[3rem] p-8 md:p-10 relative overflow-hidden">
            ...
            <form method="POST" action="{{ route('register.store') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="input-inset flex items-center px-4 rounded-xl group">
                            <input type="text" name="name" value="{{ old('name') }}"
                                class="w-full py-3 bg-transparent text-sm font-semibold text-[#094067] outline-none placeholder:text-[#90b4ce]" placeholder="Jhon Doe" required>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="input-inset flex items-center px-4 rounded-xl group">
                            <input type="tel" name="telepon" value="{{ old('telepon') }}"
                                class="w-full py-3 bg-transparent text-sm font-semibold text-[#094067] outline-none placeholder:text-[#90b4ce]" placeholder="6281..." required>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="input-inset flex items-center px-4 rounded-xl group">
                        <input type="email" name="email" value="{{ old('email') }}" class="w-full py-3 bg-transparent text-sm font-semibold text-[#094067] outline-none placeholder:text-[#90b4ce]"
                ...
                @if ($errors->any())
                    <div class="bg-[#ef4565]/5 border border-[#ef4565]/10 rounded-xl p-3">
                        @foreach ($errors->all() as $error)
                            <p class="text-[10px] font-bold text-[#ef4565] flex items-center gap-2">
